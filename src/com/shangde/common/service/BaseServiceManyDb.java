...
public abstract class BaseServiceManyDb{
     ...
     * hadata库数据源
     */
    protected ISimpleDao simpleDaoHaData;
    ...
    public ISimpleDao getSimpleDaoHaData() {
		return simpleDaoHaData;
	}

	public void setSimpleDaoHaData(ISimpleDao simpleDaoHaData) {
		this.simpleDaoHaData = simpleDaoHaData;
	}
