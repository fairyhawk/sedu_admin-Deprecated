...
public class ContractDTO implements Serializable{
   ...
   /** 访问次数*/
    ...
    private CrmFinanceDTO crmFinance;//crm 订单处理
    
    private int userId;//最后指派销售id
    private int createUserId;//乐语创建坐席id
	private String userName;//最后指派销售姓名
	private String createUserName;//乐语创建坐席姓名
	private int origin=0;//机会来源
	private Date chanceStime;//指派时间
	private Date chanceUtime;//指派时间
	...
	public CrmFinanceDTO getCrmFinance() {
		return crmFinance;
	}

	public void setCrmFinance(CrmFinanceDTO crmFinance) {
		this.crmFinance = crmFinance;
	}
