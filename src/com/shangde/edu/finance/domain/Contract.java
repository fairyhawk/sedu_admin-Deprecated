...
public class Contract implements Serializable{
	...
	public static int CONTRACT_PAY_TYPE_ZY=6;
	public static int CONTRACT_PAY_TYPE_HK=7;
    ...
    /** 支付类型 */
    private int payType; //0 为赠送　1支付宝 　2货到付款 3 网银在线 4 块钱 5代理商开通
    /** 备注  */
   ...
   /** 访问次数*/
    ...
    /** 订单折后金额（含运费） */
    private String contractPriceWithFreight;
//    /**取消时间*/
...
//	}
	...
	public String getContractPriceWithFreight() {
		BigDecimal csm = new BigDecimal(contractCutSumMoney.toString());
		contractPriceWithFreight = csm.add(new BigDecimal(freight)).toString();
		return contractPriceWithFreight;
	}

	public void setContractPriceWithFreight(String contractPriceWithFreight) {
		this.contractPriceWithFreight = contractPriceWithFreight;
	}
