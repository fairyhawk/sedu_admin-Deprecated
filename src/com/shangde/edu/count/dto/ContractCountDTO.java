...
public class ContractCountDTO implements Serializable{
	...
	private int sellPriceSum; //售卖方式价格
	...
	private String zjConvertSum;  //总计下单率
	private String zjYfConvertSum;//总计支付率
