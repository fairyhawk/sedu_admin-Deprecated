...
public class Course implements Serializable,Comparable{
    ...
    public Integer getLessionTime(){
        return lessionTime;
    }

    public void setLessionTime(Float lessionTime){
        this.lessionTime = lessionTime.intValue(); 
    }
	...
	public void setTjVedioId(Integer tjVedioId) {
		this.tjVedioId = tjVedioId!=null?tjVedioId:0;
	}
	...
	public int getRealUpNum() {
		return realUpNum;
	}

	public void setRealUpNum(int realUpNum) {
		this.realUpNum = realUpNum;
	}
