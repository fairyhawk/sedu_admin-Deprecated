...
public class SellWayDTO implements Serializable{
     ...
     * 时间版本
     */
    private String timeVerson;
    //~~~~~~~~~~~~~~~~~~~~~~~~~
    /**
     * 
     * 老师的集合
     */
    private List<TeacherCookieDTO>  teacherList;
	...
	public String getTimeVerson() {
		return timeVerson;
	}
	public void setTimeVerson(String timeVerson) {
		this.timeVerson = timeVerson;
	}
	public List<TeacherCookieDTO> getTeacherList() {
		return teacherList;
	}
	public void setTeacherList(List<TeacherCookieDTO> teacherList) {
