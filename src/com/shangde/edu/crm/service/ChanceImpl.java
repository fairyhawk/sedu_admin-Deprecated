...
public class ChanceImpl extends BaseServiceManyDb implements IChance{
    public java.lang.Integer addChance(Chance chance) {
return simpleDao.createEntity("Chance_NS.createChance",chance);
    }

    public void delChanceById(int id){
        simpleDao.deleteEntity("Chance_NS.deleteChanceById",id);
    }

    public void updateChance(Chance chance) {
        simpleDao.updateEntity("Chance_NS.updateChance",chance);
    }
    ...
    public Chance getChanceByCrmUserId(int crmUserId){
    	 ...
    	 return simpleDao.getEntity("Chance_NS.getChanceByCrmUserId",crmUserId);
    }
    ...
    public ChanceRecordDTO getChanceRecordDTO(int crmChanceId){
    	return simpleDao.getEntity("Chance_NS.getChanceRecordDTO", crmChanceId);
    }
    ...
    public List<User> getSoldUserList(QueryChanceCondition queryChanceCondition){
    	return simpleDao.getForList("Chance_NS.getSoldUserList", null);
    }
    ...
    public List<UserDTO>getSeatsListByGroupId(int groupId){
    	return simpleDao.getForList("Chance_NS.getSeatsListByGroupId", groupId);
    }
    /**
    ...
    public List<UserDTO>getSignSeatsListByGroupId(int groupId){
    	return simpleDao.getForList("Chance_NS.getSignSeatsListByGroupId", groupId);
    }
    /**
     * 获取自然注册指派销售人员列表
     * @author 王超 
    ...
    public List<UserDTO> getSignSeatsList(){
    	return simpleDao.getForList("Chance_NS.getSignSeatsList", null);
    }
    ...
    public List<UserDTO> getUnsignSeatsList(){
    	return simpleDao.getForList("Chance_NS.getUnsignSeatsList", null);
    }
    /**
     * 快捷筛选获取自然注册
     * 非指派销售人员列表
    ...
    public List<UserDTO> getSearchUnsignSeats(String keyword){
    	return simpleDao.getForList("Chance_NS.getSearchUnsignSeats", keyword);
    }
    /**
     * 自定义自然注册销售指派
     */
    public void updateSeatsDefine(Map<String, Object> map){
    	simpleDao.updateEntity("Chance_NS.seatsDefine",map);
    }
    ...
    public void updateSeatsEmpty(int groupId){
    	simpleDao.updateEntity("Chance_NS.seatsEmpty",groupId);
    }
    ...
    public List<ContractCrmDTO> getContractByCusId(int cusId){
    	return simpleDao.getForList("Chance_NS.getBackContractByCusId",cusId);
    }
    
    public Integer getContractNum(int cusId){
    	return simpleDao.getEntity("Chance_NS.getContractNum", cusId);
    }
    public Integer getContractNumPay(int cusId){
    	return simpleDao.getEntity("Chance_NS.getContractNumPay", cusId);
    }
    ...
    public PageResult getSalesStat(QueryStatCondition queryStatCondition){
    	//return simpleDao.getPageResult("Chance_NS.getSalesStat", "Chance_NS.getSalesStatCount", queryStatCondition);
    	return simpleDao.getPageResult("Chance_NS.getSalesStatNew", "Chance_NS.getSalesStatNewCount", queryStatCondition);
    ...
    public List<SalesStatDTO> getSalesStatByHour(QueryStatCondition queryStatCondition){
    	return simpleDao.getForList("Chance_NS.getSalesStatByHourNew", queryStatCondition);
    }
    ...
    public Integer updategetBatchChance(Map<String, Object> map){
    	return simpleDao.update("Chance_NS.getBatchChance", map);
    }
    ...
    public Integer getDrawChanceCount(int userId){
    	return simpleDao.getEntity("Chance_NS.getDrawChanceCount", userId);
    }
    ...
    public Integer getTiming(){
    	return simpleDao.getEntity("Chance_NS.getTiming", null);
    }
    ...
    public Integer updateTiming(int timingNum){
    	return simpleDao.update("Chance_NS.updateTiming", timingNum);
    }
    /**
     * 获取全部销售机会列表导出excel
     * @author 代长福
