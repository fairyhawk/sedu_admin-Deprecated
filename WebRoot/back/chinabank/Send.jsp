...
String v_mid,key,v_url,v_oid,v_amount,v_moneytype,v_md5info;  //定义必须传递的参数变量
	...
	v_mid = "22077726";			                 	          // 商户号，这里为测试商户号1001，替换为自己的商户号(老版商户号为4位或5位,新版为8位)即可
	v_url = "http://localhost:8080/sedu/chinabank/Receive.jsp";     // 商户自定义返回接收支付结果的页面
	  key = "shangde^2011";									      // 如果您还没有设置MD5密钥请登陆我们为您提供商户后台，地址：https://merchant3.chinabank.com.cn/
