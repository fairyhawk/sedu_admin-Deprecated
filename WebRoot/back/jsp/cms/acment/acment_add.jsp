...
<body>
<div id="rightframe">
	<form action="<%=contextPath%>/cms/acment!add.action" id="acmentForm" name="acmentForm" method="post" onsubmit="return check();" >
	<table width="100%" border="0" cellspacing="0"  cellpadding="0" class="lists">
		<tr>
			...
			<td class="lists_top">
				<font class="lists_fleft">添加公告</font>
			</td>
			<td style="font-size:0px;width:12px;">
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="0" class="lists_info">
		    	...
		    	<tr style="height: 30px">
		    		<td width="10%">*公告标题：</td>
		    		<td class="lists_tleft" width="90%">
		    			<input type="text" name="announcement.title" id="title" maxlength="100" />
		    		</td>
		    	</tr>
		    	<tr style="height: 30px">
		    		<td width="10%">*发布作者：</td>
		    		<td class="lists_tleft" width="40%"> 
		    			<input type="text" name="announcement.author" id="author" maxlength="50" />
		    		</td>
		    	</tr>
		    	<tr style="height: 30px">
		    		<td width="10%">*公告状态：</td>
				...
				<tr>
		    		<td width="10%">*公告内容：</td>
		    		<td width="90%" align="left" class="lists_tleft">
		    		<textarea id="content" name="announcement.content" cols="100" rows="8" style="width:560px;height:365px;visibility:hidden;"></textarea>
					</td>
		    	</tr>
		    	<tr>
		    		<td style="text-align: center;" colspan="2"><input class="submit" type="submit" value="提交"/>	<input class="submit" type="button" value="公告预览" onclick="yulan()" /></td>
		    	</tr>
			</table>
			</td>
