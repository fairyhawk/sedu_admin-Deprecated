...
<html>
  ...
  <div>
	<form action="<%=contextPath %>/ass/assess!updateAssess.action" method="post" name="updateForm" id="updateForm" enctype="multipart/form-data" onsubmit="return updateCheck();">
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="0" class="lists_info">
				...
				<tr height="30">
					...
					<td class="lists_tleft">
						<input type="text" name="assess.assTitle" id="title" value="<s:property value="assess.assTitle"/>"/>
					</td>
				</tr>
				<tr height="30">
					<td>
					...
					<td class="lists_tleft">
						<select id="lvl" name="assess.assLeavel">
				...
				<tr height="30">
					...
					<td class="lists_tleft">
						<s:hidden id="assstatus" name="assess.status"/>
						<select id="sta" name="sta"> <option value="-1"> 请选择 </option><option value="0"> 未审 </option> <option value="1"> 发布 </option><option value="2"> 新稿 </option><option value="3"> 删除 </option></select>
					</td>
				</tr>
				<tr height="30">
					<td>
					...
					<td class="lists_tleft">
						<textarea rows="5" cols="50" id="assess.assContext" name="assess.assContext"><s:property value="assess.assContext" /></textarea>
					</td>
				</tr>
				<tr height="30">
					<td>
					...
					<td class="lists_tleft">
						<textarea rows="5" cols="50" id="reassess.reassContext" name="reassess.reassContext"><s:property value="reassess.reassContext" /></textarea><br />
				...
				<tr height="30">
					...
					<td class="lists_tleft">
						<textarea rows="5" cols="50" id="assess.verifyContext" name="assess.verifyContext"><s:property value="assess.verifyContext" /></textarea>
					</td>
				</tr>
				<tr height="30">
					<td colspan="2">
