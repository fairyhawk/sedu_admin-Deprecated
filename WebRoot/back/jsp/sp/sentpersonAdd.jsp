...
<html>
	...
	<body>
		<div>
		<form action="<%=contextPath%>/sp/sentperson!addSentPerson.action" method="post" name="sentPersonForm" id="sentPersonForm" onsubmit="return onSubmit();">
		<table width="100%" border="0" cellspacing="0"  cellpadding="0" class="lists">
			<tr >
				...
				<td class="lists_top">
					<font class="lists_fleft">新建信息接收人</font>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="0" class="lists_info">
				<tr height="30">
					...
					<td class="lists_tleft" colspan="2">
						<input type="text" value="" name="querySentPersonCondition.personName" id="personName" style="width:180px;"/>
				...
				<tr height="30">
					...
					<td class="lists_tleft" colspan="2">
						<input type="text" value="" name="querySentPersonCondition.personPhone" id="personPhone" style="width:180px;"/>
					<span class="jqVaildate"></span>
					</td>
				</tr>
