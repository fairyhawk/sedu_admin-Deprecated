...
<link rel="stylesheet" type="text/css" media="screen"	href="<%=contextPath%>/back/style/css_body.css" />
	...
	<body>
<div>
	<form action="cou/clazz!addClazz.action" method="post" name="clazzform" id="clazzform" enctype="multipart/form-data">
				...
				<tbody id="tagTb">
					<tr>
						...
						<td class="lists_tleft">
							<input type="text" name="clazz.title" id="clazz.title"/>
						</td>
					</tr>
					...
					<tr>
						...
						<td class="lists_tleft">
							<textarea rows="" cols="" name="clazz.introduce" class="{required:true,minlength:4,maxlength:1000}" style="height:80px;width:99%;"></textarea>
						</td>
					</tr>
					...
					<tr>
						...
						<td class="lists_tleft">
							<input name="clazz.clazzOfferPrice" type='text'/>
						</td>
					</tr>
					...
					<tr>
						...
						<td class="lists_tleft">
							<input type="file" name="clazzIndexPic" id="clazzIndexPic"
								class="{required:true}" onchange="changeMainPic(this)"/>
					...
					<tr>
						...
						<td class="lists_tleft">
							<input type="file" name="clazzPic" id="clazzPic"
								class="{required:true}" onchange="changePic(this)"/>
							<div class="uploadPic" id="clazzPicDiv"></div>
							<img id="clazzPicImg" style="display:none"/>
						</td>
					</tr>
				</tbody>
			</table>
