...
<body>
<div>
	<form action="<%=contextPath %>/sys/modules!doAdd.action" method="post" name="addForm" id="addForm">
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="0" class="lists_info">
				<tr>
					...
					<td class="lists_tleft">
						<input type="text" name="modules.name" class="{required:true,minlength:4,maxlength:50}" />
					</td>
				</tr>
				<tr>
					<td class="lists_tright">
				...
				<tr>
					...
					<td class="lists_tleft">
						<font color="red">/static/container/</font><input ty`pe="text" name="modules.url" class="{required:true}"/>例如：<font color="red">(aaa)</font>
					</td>
				</tr>
				<tr>
					<td class="lists_tright">
					...
					<td class="lists_tleft">
						<textarea name="modules.desc" style="width:720px;height:100px"></textarea>
					</td>
				</tr>
				<tr>
					<td class="lists_tright"></td>
					<td class="lists_tleft">
						<input type="submit" value="创建模板"/><input type="button" value="返回" onclick="history.go(-1)"></input>
					</td>
				</tr>	
			</table>
			</td>
