...
<div>
	...
	<table width="100%" border="0" cellspacing="0"  cellpadding="0" class="lists">
		<tr >
			...
			<td class="lists_top">
				<font class="lists_fleft">修改用户密码</font>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="0" class="lists_info">
				<tr>
					...
					<td class="lists_tleft">
						<input type="text" readonly value="<s:property value="user.userName"/>"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td class="lists_tleft">
						<input type="text" readonly value="<s:property value="user.loginName"/>"/>
					</td>
				</tr>
				<tr>
					<td>
