...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function back(){
				window.location.href="<%=contextPath%>/kb/professional!getProfessionalList.action"
			}
	...
	<body>
		<div class="main_right">
			<s:form action="professional!professionalEdit" method="post"
				name="editProfessionalForm" id="editProfessionalForm" onsubmit="return editPro()">
				<table width="100%" border="0" cellspacing="1" cellpadding="0"
					...
					<tr >
						...
						<td class="lists_top">
							<font class="lists_fleft">当前位置:[预设项管理>>专业基本信息设置]</font>
					...
					<table width="50%" border="0" cellspacing="1" cellpadding="0"
								class="lists_info">
					<s:hidden name="professional.pId" value="%{professional.pId}"></s:hidden>
					<!--  <tr>
						<td align="left">
						...
						<td>
							<input type="text" name="professional.pIndex"
								...
								value="<s:property value="professional.pIndex"/>" class="{required:true,minlength:3,maxlength:50}"/>
						</td>
					</tr>-->
					<input type="hidden" name="professional.pIndex" value="<s:property value="professional.pIndex"/>">
					<tr>
						<td align="left">
						...
						<td>
							<input type="text" name="professional.pName"
								...
								value="<s:property value="professional.pName"/>" class="{required:true,minlength:4,maxlength:50}"/>
						</td>
					</tr>
					<tr>
						<td align="left">
						...
						<td>
							<input type="text" name="professional.pCSubject"
								...
								value="<s:property value="professional.pCSubject"/>" class="{required:true,minlength:2,maxlength:50}"/>
						</td>
					...
					<tr>
						...
						<td>
							<input type="text" name="professional.pVersion"
								...
								value="<s:property value="professional.pVersion"/>" class="{required:true,minlength:4,maxlength:50}"/>
						</td>
					</tr>
					<tr>
						<td align="left">
						...
						<td>
							<textarea name="professional.pNote" rows="5" cols="18"id="professional.pNote" maxsize="255" eos_displayname="描述"chname="描述" nullable="no" datatype="text"><s:property value="professional.pNote" /></textarea>
						</td>
					</tr>
					<tr>
