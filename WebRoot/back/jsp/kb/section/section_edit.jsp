...
<html>
	...
	<div class="main_right">
		<h1>信息添加——节基本信息设置</h1>
	<s:form action="section!sectionEdit" method="post" name="editSectionForm"  id="editSectionForm">
				 <table cellpadding="0" cellspacing="1" class="tables"  style="width:600px;height:200px;">
					...
					<s:hidden name="section.sId" value="%{section.sId}"></s:hidden>
					<tr>
						<th align="left">
		               ...
		               <tr>
						...
						<td>
						  <textarea name="section.sNote" rows="5" cols="18" id="section.sNote"
									...
									datatype="text" class="{required:true,minlength:4,maxlength:200}"><s:property value="section.sNote"/></textarea>
						</td>
		            </tr>
					<tr>
