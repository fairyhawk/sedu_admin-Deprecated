...
<html>
	...
	<body class="manage">
		<div class="main_right">
			<form name="updateDifForm" id="updateDifForm"
				action="<%=contextPath%>/kb/difficulty!updateDifficulty.action"
				method="post">
				<table width="100%" border="0" cellspacing="1" cellpadding="0"
					...
					<tr >
						...
						<td class="lists_top">
							<font class="lists_fleft">当前位置:[预设项管理>>修改难度项]</font>
							...
							<table width="50%" border="0" cellspacing="1" cellpadding="0"
								...
								<tr>
									...
									<td>
										...
										级
										<s:hidden name="difficulty.dLevel" id="difficulty.dLevel" />
									</td>
								</tr>
								<tr>
									<td>
									...
									<td>
										<input type="text" name="difficulty.dName"
											id="difficulty.dName"
											value="<s:property value="difficulty.dName"/>"
											class="{required:true,minlength:2,maxlength:50}" />
										<s:hidden name="difficulty.dId" id="difficulty.dId" />
										<s:hidden name="difficulty.note" id="difficulty.note" />
