...
<link rel="stylesheet" type="text/css" media="screen"	href="<%=contextPath%>/back/style/css_body.css" />
	...
	<body>
<div>
	<form action="<%=contextPath %>/exam/exampaper!Qstadd.action" method="post" enctype="multipart/form-data" name="exampaperaddform" id="exampaperaddform" onsubmit="return doSubmit()">
				...
				<TBODY id="tagTb">
					...
					<tr>
						...
						<td class="lists_tleft" colspan="2">
							...
							<input  type="text" class={required:true,maxlength:100,minlength:4} id="exam.epName" maxlength="12" value="<s:property value="exam.epName"/>" />	
							<input name="exam.epId" type="hidden" class={required:true,maxlength:100,minlength:4} id="exam.epId" maxlength="12" value="<s:property value="exam.epId"/>" />		卷名限定12个字				</td>
					</tr>
					<tr>
						<td>
							考试描述
						...
						<td class="lists_tleft" colspan="2">
							<textarea  rows="" cols="" 
								class="{required:true,minlength:4,maxlength:1000}" style="height:80px;width:99%;"><s:property value="exam.epInfo"/></textarea>						</td>
					</tr>
					<tr  id="nj">
						<td>
							所属专业
							<font color="#ff0000">*</font>						</td>
						<td class="lists_tleft" colspan="2">
							<s:select  id="exam.subjectId" list="subjectList" listKey="subjectId" listValue="subjectName" headerKey="-1"
					...
					<tr>
						...
						<td class="lists_tleft">
							<input type="text"  id="exam.replyTime" class={required:true,digits:true,min:0} value="<s:property value='exam.replyTime'/>" />						</td>
					</tr>
					<tr>
						<td>试卷难度系数<font color="#ff0000">*</font></td>
						<td class="lists_tleft" ><s:select  id="exam.coeffcient" list="examlevel" listKey="key" listValue="value" headerKey="-1"
					...
					<tr>
						...
						<td  class="lists_tleft">
							<s:select  id="courseId" list="#{}" headerKey="-1"
					...
					<tr>
						<td>
							测试类型：						</td>
						<td class="lists_tleft" colspan="2">
						  <select  id="select" onchange="ceshi(this.value)"> 
					...
					<tr>
						...
						<td class="lists_tleft" colspan="2">
						<s:select  id="zzhuyeId" list="professionalList" listKey="pId" listValue="pName" headerKey="-1"
					...
					<tr colspan="2">
						<td>
							...
							<font color="#ff0000">*</font>						</td>
						<td class="lists_tleft" colspan="2">
							<input type="text" name="exam.epTotelScore" id="exam.epTotelScore" class={required:true,digits:true,min:0} value="<s:property value='exam.epTotelScore'/>" />	
							此题的总分=当前的分数+要添加试题的总分数
							<input type="hidden" id="epTotelScore" class={required:true,digits:true,min:0} value="<s:property value='exam.epTotelScore'/>" />						</td>
					</tr>
					<tr>
						<td>
							考试评语（PCT正确率）
