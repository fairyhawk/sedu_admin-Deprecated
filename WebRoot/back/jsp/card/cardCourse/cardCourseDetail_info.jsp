							...
							<table width="100%" border="0" cellspacing="1" cellpadding="0" class="lists_info" id="tblList">
								<tbody id="tagTb">
									...
									<tr>
										...
										<td class="lists_tleft" >
											<s:property value='cardCourseModel.cardName'/>
										</td>
									</tr>
									<tr>
										<td class="lists_tright" width="10%">
										...
										<td class="lists_tleft" >
											<s:property value='cardCourseModel.cardCourseCode'/>
										</td>
									</tr>
									<tr>
										<td class="lists_tright" width="10%">
										...
										<td class="lists_tleft" >
											<s:property value='cardCourseModel.cardMoney'/>
										</td>
									</tr>
										<tr>
										<td class="lists_tright" width="10%">
										...
										<td class="lists_tleft" >
											<s:property value='cardCourseModel.agentMoney'/>
										</td>
									</tr>
									<tr>
										<td class="lists_tright" width="10%">
										...
										<td class="lists_tleft" >
											<s:property value='cardCourseModel.cardCourseStatusContent'/>
										</td>
									</tr>
									<tr>
										<td class="lists_tright" width="10%">
										...
										<td class="lists_tleft" >
											<s:date name='cardCourseModel.validBeginTime' format='yyyy-MM-dd'/> - <s:date name='cardCourseModel.validEndTime' format='yyyy-MM-dd' />
										</td>
									</tr>
									<tr>
										<td class="lists_tright" width="10%">
										...
										<td class="lists_tleft" >
											<s:property value="cardCourseModel.remark" />
										</td>
									</tr>
									<tr>
										<td class="lists_tright" width="10%">
										...
										<td class="lists_tleft" >
											<s:property value="cardCourseModel.activateRemark" />
										</td>
									</tr>
									<tr>
										<td class="lists_tright" width="10%">
						      			...
						      			<td class="lists_tleft">
					   						<span style="float:left;">
				   								<img src="http://import.highso.org.cn/upload/shop/${cardCourseModel.imageUrl}" alt="" width="100px" height="100px"  style="padding-left: 80px" id="couponpic"/>
					   						</span> 
					   					</td>
									</tr>
								</tbody>
