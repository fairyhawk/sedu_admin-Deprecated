...
<link rel="stylesheet" type="text/css" media="screen"	href="<%=contextPath%>/back/style/css_body.css" />
  ...
  <body>
<form action="<%=contextPath%>/res/tryVedio!addTjVedio.action"  method="post" name="kpointform" id="kpointform" enctype="multipart/form-data">
<div>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="0" class="lists_info">
		    	...
		    	<tr>
		    		...
		    		<td class="lists_tleft" width="80%" style="color: #ff0000;">
						...
						<input type="text" name="tryvedio.buyMethod" />
		    		</td>
		    	</tr>
		    	<tr>
		    		<td align="right" width="20%">图片路径：</td>
		    		<td class="lists_tleft" width="80%" style="color: #ff0000;">
		    			<!-- <input type="text" name="tryvedio.picPath"/> -->
		     	...
		     	<tr>
		    		...
		    		<td class="lists_tleft" width="80%" style="color: #ff0000;">
						...
						<input type="text" name="tryvedio.title" />
		    		</td>
		    	</tr>
		    	...
		    	<tr>
		    		...
		    		<td class="lists_tleft" width="80%" style="color: #ff0000;">		    			
						<input type="text" name="tryvedio.info"/>
		    		</td>
		    	</tr>
		    	<tr>
		    		<td align="right" width="20%">点击量：</td>
		    		<td class="lists_tleft" width="80%" style="color: #ff0000;">		    			
						<input type="text" name="tryvedio.clickTimes"/>
		    		</td>
		    	</tr>
		    	<tr>
		    		<td align="right" width="20%">URL：</td>
		    		<td class="lists_tleft" width="80%" style="color: #ff0000;">		    			
						<input type="text" name="tryvedio.url"/>
		    		</td>
		    	</tr>
			</table>
			</td>
...
<div>
		...
		<tr>
			...
			<td>
				<s:hidden name="tryvedio.courseId" id="tjcourse.courseId"></s:hidden>	    		
