...
<script type="text/javascript" src="<%=contextPath%>/back/script/jquery-1.3.2.js"></script> 
	...
	<body>
<div>
	<s:form action="vediogroup!addVedioGroup" method="post" name="addVedioGroupForm" id="addVedioGroupForm">
	<table width="100%" border="0" cellspacing="0"  cellpadding="0" class="lists">
		<tr >
			...
			<td class="lists_top">
				<font class="lists_fleft">信息添加——视频组基本信息设置</font>
				...
				<tr>
					...
					<td class="lists_tleft">
						<input type="text" name="vedioGroup.vgType" id="vedioGroup.vgType"
							 class="{minlength:4,maxlength:50}"/>
					</td>
				</tr>
				<tr>
					<td align="left">
