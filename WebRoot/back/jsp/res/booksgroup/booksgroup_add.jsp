...
<link rel="stylesheet" type="text/css" media="screen"	href="<%=contextPath%>/back/style/css_body.css" />
		...
		<script type="text/javascript">
			$().ready(function() {
	 			$("#addBooksGroupForm").validate();
			});
		</script>
	</head>
	<body>
<div>
	<s:form action="booksgroup!addBooksGroup" method="post" name="addBooksGroupForm"  id="addBooksGroupForm">
	<table width="100%" border="0" cellspacing="0"  cellpadding="0" class="lists">
		<tr >
			...
			<td class="lists_top">
				<font class="lists_fleft">信息添加——书籍组基本信息设置</font>
