...
<body>
<div id="detailWin">
	<form action="finance/refd!confirm.action" method="post" id="f1">
	<input type="hidden" value="${refundDTO.id}" name="refund.id" id="refundid"></input>
	<input type="hidden" value="${refundDTO.cashid}" name="refund.cashid" id="cashid"></input>
	<input type="hidden" value="${refundDTO.contractno}" name="refund.contractno" id="contractno"></input>
	<table width="100%" border="0" cellspacing="0"  cellpadding="0" class="lists">
		<tr>
        <td class="td_wid_l"><img src="<%=contextPath%>/back/images/tab_03.gif" /></td>
        <td class="lists_top"><font class="lists_fleft">确认退费</font></td>
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="0" class="lists_info">
				...
				<tr height="30" >
					<td  class="lists_tright" id="cusbanknametd">
						开户人姓名:
					</td>
					<td class="lists_tleft">
				...
				<tr height="30">
					<td  class="lists_tright" id="bankcodetd">
						退费账号:
					</td>
					<td class="lists_tleft">
						${refundDTO.bankcode}
				...
				<tr height="50">
				 ...
				 <td colspan="2" align="center"><input type="button" onclick="validateF();" value="确认退费"/>&nbsp;&nbsp;<input type="button" onclick="javascript:history.go(-1)" value="返回"/> </td></tr> 
			</table>
			</td>
