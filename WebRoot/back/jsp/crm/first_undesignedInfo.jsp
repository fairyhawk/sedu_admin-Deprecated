...
<html>
	...
	function selectX(){
			...
			document.forms.salesStat.action="<%=contextPath %>/crm/salesStat!toAllUndesignedInfo.action?queryStatCondition.currentPage=1";
			document.forms.salesStat.submit();
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					...
					<td>
		<form action='<%=contextPath %>/crm/salesStat!toUndesignedInfo.action' name="salesStat" method="post">
		  <div class="msg-yw">
