  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0"
		...
		<table width="75%" border="0" cellpadding="0" cellspacing="1" class="lists">
		  <tr>
			...
			<td width="15%" class="lists_tleft"><s:select list="groupList" name="queryStatCondition.groupId" listKey="groupId" listValue="groupName" headerKey="0"
										headerValue="请选择项目组"  id="groupid"  onchange="selected(this.value);"></s:select></td>
