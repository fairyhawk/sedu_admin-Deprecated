...
<html>
	...
	<script type="text/javascript">
		...
		if(startTime!=''&&endTime!=''){
			...
			document.forms.salesStat.action="<%=contextPath %>/crm/salesStat!toXSSalesStat.action?queryStatCondition.currentPage=1";
			document.forms.salesStat.submit();
		}
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					...
					<td>
					<div class="msg-yw">
		<form action='<%=contextPath %>/crm/salesStat!toXSSalesStat.action' name="salesStat" method="post">
		<table width="75%" border="0" cellpadding="0" cellspacing="1" class="lists">
		  <tr>
			<td width="8%" class="lists_tright">销售项目组:</td>
			<td width="15%" class="lists_tleft"><s:select list="groupList" name="queryStatCondition.groupId" listKey="groupId" listValue="groupName" id="groupid"  onchange="selected(this.value);"></s:select></td>
