...
function dTree(objName, imgUrl) {
	...
	this.icon = {
		...
		empty : imgUrl + '/empty.gif',

		line : imgUrl + '/line.gif',

		join : imgUrl + '/join.gif',

		joinBottom : imgUrl + '/joinbottom.gif',

		plus : imgUrl + '/plus.gif',

		plusBottom : imgUrl + '/plusbottom.gif',

		minus : imgUrl + '/minus.gif',

		minusBottom : imgUrl + '/minusbottom.gif',

		nlPlus : imgUrl + '/nolines_plus.gif',

		nlMinus : imgUrl + '/nolines_minus.gif'
